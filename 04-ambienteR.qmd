...
Em sequência, executar o instalador baixado *RStudio-2025.05.1-513.exe* ^[Versão disponível em 10/06/2025] e seguir as suas instruções.  

### Iniciando o  *RStudio*   

Para iniciar o  *RStudio*  basta clicar no ícone indicativo (@fig-icone) que se encontra no menu *Iniciar* do Windows.

```{r #fig-icone, echo = FALSE, out.width = '15%', fig.align = 'center', fig.cap="Ícone do RStudio", fig.pos="ht"}
...
```{r #fig-inicial, echo = FALSE, out.width = '70%', fig.align = 'center', fig.cap="Tela inicial do RStudio", fig.pos="ht"}
...
```{r #fig-console, echo = FALSE, out.width = '60%', fig.align = 'center', fig.cap="Console", fig.pos="ht"}
...
```{r #fig-script, echo = FALSE, out.width = '70%', fig.align = 'center', fig.cap="R Script", fig.pos="ht"}
...
```{r #fig-auto, echo = FALSE, out.width = '70%', fig.align = 'center', fig.cap="Menu autocompletável", fig.pos="ht"}
...
```{r #fig-tutorial, echo = FALSE, out.width = '50%', fig.align = 'center', fig.cap="Tutoriais do RStudio", fig.pos="ht"}
...
```{r #fig-ajuda, echo = FALSE, out.width = '90%', fig.align = 'center', fig.cap="Ajuda do RStudio", fig.pos="ht"}
...
```{r #fig-install, echo = FALSE, out.width = '70%', fig.align = 'center', fig.cap="Instalação do pacote 'ggplot2' usando a caixa de diálogo 'Install Packages'", fig.pos="ht"}
...
```{r #fig-wd, echo = FALSE, out.width = '85%', fig.align = 'center', fig.cap="Diretório de trabalho", fig.pos="ht"}
...
```{r #fig-projeto, echo = FALSE, out.width = '60%', fig.align = 'center', fig.cap="Assistente de novo projeto.", fig.pos="ht"}
...
```{r #fig-help, echo = FALSE, out.width = '60%', fig.align = 'center', fig.cap="Ajuda para Média Aritmética.", fig.pos="ht"}
...
```{r #fig-twopop, warning=FALSE, out.width="70%", fig.cap="Comparação da altura de mulheres em duas populações", out.height="70%", fig.align='center'}
dados <- readxl::read_excel("dados/dadosPop.xlsx")
dados$pop <- as.factor(dados$pop)
plotBpT (df = dados, var.x = pop, var.y = altura)
```

Observe na @fig-twopop onde aparece o resultado do teste t ($P = 2,2 \times 10^-16$) e os boxplots em posições bem diferentes (veja @sec-bxp).  
