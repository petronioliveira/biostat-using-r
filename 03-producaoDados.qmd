...
O tamanho amostral mínimo é determinado por fórmulas estatísticas complexas. Os cálculos são muito pesados, mas agora, felizmente, existem programas de computador disponíveis que realizam este trabalho, por exemplo o **G-Power3** @faul2007g. Além disso, é possível acessar um site que fornece informações e ferramentas para o cálculo amostral em pesquisas da área da saúde [^03-producaodados-1]. Existem tabelas extensas para calcular o número de participantes @cohen1988statistical para um determinado nível de poder (e vice-versa).

[^03-producaodados-1]: <http://calculoamostral.bauru.usp.br/calculoamostral/index.php>
...
Os estudos caso-controle, portanto, partem da presença ou ausência de um desfecho e após olham para trás no tempo (retrospectivamente) para detectar possíveis fatores de risco (@fig-cc)) @fletcher2014risco. Analisam o que aconteceu e são usados para investigar fatores de risco de doenças raras onde um estudo prospectivo seria muito longo para identificar uma quantidade suficiente de casos.   
...
```{r #fig-cc, echo = FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Desenho de um estudo caso controle.", fig.pos="H"}
...
[Casos incidentes ou prevalentes]{.underline}
...
```{r #fig-aninhado, echo = FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Desenho de um estudo caso-controle aninhado.", fig.pos="H"}
...
Um esquema simplificado de um estudo de coorte é mostrado na @fig-coorte @fletcher2014coorte.  

```{r #fig-coorte, echo = FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Desenho de um estudo de coorte sobre risco.", fig.pos="H"}
...
1)	Seleciona-se a população-alvo baseado no fato dos indivíduos estarem expostos ou não ao fator em estudo (@fig-coorte); 
2)	Ou seleciona-se a população-alvo antes que qualquer um dos seus membros se torne exposto, ou antes, que a exposição seja identificada (@fig-coorte2). Um exemplo típico deste modelo é o clássico Estudo de Framingham @kannel1979diabetes.  

```{r #fig-coorte2, echo = FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Desenho de uma coorte com grupos expostos e não expostos.  @david2019gordis.", fig.pos="h"}
...
Um ensaio clínico deve ter algumas características fundamentais (@fig-trial) @fletcher2014tratamento:  
...
```{r #fig-trial, echo = FALSE, out.width = '80%', fig.align = 'center', fig.cap = "Estrutura de um ensaio clínico randomizado.", fig.pos="H"}
 knitr::include_graphics("https://i.imgur.com/kv9IYVe.png")
```

### Elementos básicos de um ensaio clínico  

1) [Seleção dos participantes]{.underline}  
...
3) [Condução/Seguimento/Avaliação]{.underline}  
...
4. [Intenção de tratar]{.underline}  
...
5) [Análise da magnitude do efeito]{.underline}  
...
```{r #fig-cruzado, echo = FALSE, out.width = '45%', fig.align = 'center', fig.cap = "Ensaio clínico randomizado com delineamento cruzado.", fig.pos="H"}
