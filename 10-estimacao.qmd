...
```{r #fig-intconf, echo = FALSE, out.width = '60%', fig.align = 'center', fig.cap="Intervalo de Confiança.", fig.pos="H"}
...
```{r #fig-IC9599, echo = FALSE, out.width = '60%', fig.align = 'center', fig.cap="Comparação do IC95% e IC99%.", fig.pos="H"}
...
```{r #fig-vinte, echo=FALSE, fig.out="60%", fig.cap="Intervalos de confiança de 95% que mostra 20 replicações simuladas de amostras de n = 30 do peso do recém-nascido. Apenas um intervalo (em vermelho) não inclui a média populacional (linha vertical azul)."}
ggplot2::ggplot(dfx, 
                aes(x = sample.means, 
                    y = trial, 
                    xmin = lcl, 
